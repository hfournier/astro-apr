...
description: 'In the Agile world a cross-functional team is one that has all the skills it requires to get the work finished, without relying on external help. Wow, that''s a mouthful. Let''s provide some examples. A team doing software development might have a mix of the following skills: Development, Requirements Analysis, Quality Assurance, User Experience etc. ...'
type: glossary
createdAt: 2023-09-15T14:20:03
modifiedAt: 2024-02-03T16:22:23
author: mark-levison
---

import { Image } from "astro:assets"

import colo_DevOps_Mindset_Kanban_Board_Typical_Scrum_Team_1024x161_png from "DevOps-Mindset-Kanban-Board-Typical-Scrum-Team-1024x161.png";
import colo_DevOps_Mindset_Kanban_Board_blog_variation_2_1024x170_jpg from "DevOps-Mindset-Kanban-Board-blog-variation-2-1024x170.jpg";
...
<Image decoding="async" alt="Typical Scrum Team" width="1024" height="161" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_DevOps_Mindset_Kanban_Board_Typical_Scrum_Team_1024x161_png} widths={[1024, 300, 768, 1380]} />

Example of a team that owns their value stream from end to end:

<Image decoding="async" alt="Truly Cross-Functional Scrum Team" width="1024" height="170" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_DevOps_Mindset_Kanban_Board_blog_variation_2_1024x170_jpg} widths={[1024, 300, 768, 1380]} />
...
[Cross-skilling](/glossary/cross-skilling)  
[Part-time Team Members](/glossary/part-time-team-members)  
[Scrum Teams](/glossary/scrum-team)  
[Special Teams](/glossary/special-teams)