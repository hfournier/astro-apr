...
wpId: 11801
title: 'User Story'
description: 'In Scrum, a User Story is a tool used to provoke, and then summarize, a conversation between the Development Team and their Product Owner, for a better understanding of an item on the Product Backlog. The User Story provides context regarding who a Product Backlog Item is being developed for, and why it is of value. Are User Stories ...'
type: glossary
createdAt: 2023-11-09T21:59:04
modifiedAt: 2024-09-17T13:52:45
author: mark-levison
---

import { Image } from "astro:assets"

import colo_User_Story_slices_png from "User-Story-slices.png";
import colo_user_story_index_card_blank_jpg from "user-story-index-card-blank.jpg";
...
import colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_A_v2_1024x607_jpg from "APR_Blog-Illustrations_Nov2019_AcceptanceCriteria_A_v2-1024x607.jpg";
...
<Image decoding="async" alt="User Story slices, image by Agile Pain Relief Consulting" width="265" height="240" sizes="(max-width: 265px) 100vw, 265px" src={colo_User_Story_slices_png} widths={[400, 300]} />
...
<Image decoding="async" alt="user story index card - common format" width="458" height="270" sizes="(max-width: 458px) 100vw, 458px" src={colo_user_story_index_card_blank_jpg} widths={[458, 300]} />
...
<Image decoding="async" alt="Definition of Done vs. User Stories vs. Acceptance Criteria - image by Agile Pain Relief Consulting" width="500" height="297" sizes="(max-width: 500px) 100vw, 500px" src={colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_B_v2_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
...
<Image decoding="async" alt="Definition of Done vs. User Stories vs. Acceptance Criteria - image by Agile Pain Relief Consulting" width="500" height="297" sizes="(max-width: 500px) 100vw, 500px" src={colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_A_v2_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
...
[User Story Splitting](/glossary/user-story-splitting)
