...
wpId: 12882
title: 'Swarming'
description: 'If Pair Programming is two people working together on a single problem at the same time (pre-Covid, Pairing meant sitting side by side with one computer), then Swarming takes Pairing to the next level, with three or more people working on a problem together. Most teams discover Swarming as they approach the end of the ...'
type: glossary
createdAt: 2021-12-02T15:23:54
...
[Scrum by Example – Overtime on a Scrum Team is an Unhealthy Sign](/blog/scrummaster-tales-overtime-on-a-scrum-team-is-an-unhealthy-sign.html) – Swarming would have helped, just a bit.  
[Scrum by Example – The Story of an Incomplete Sprint](/blog/scrum-by-example-the-story-of-an-incomplete-sprint.html) – the classic example that should lead to a team discovering Swarming.
...
[Ensemble Programming](/glossary/ensemble-programming)  
