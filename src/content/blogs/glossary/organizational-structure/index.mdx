...
description: 'It''s strange to start becoming Agile and assume that Organizational Structure won''t change. As Agile steers an organization to focus on Product and improving effectiveness, the structure must change too. We can''t prescribe a specific structure, since each organization is unique. However, we can see general trends. Agile approaches push decision-making power closer to the ...'
type: glossary
createdAt: 2022-07-13T13:38:18
modifiedAt: 2024-03-04T17:11:27
author: mark-levison
---

import { Image } from "astro:assets"

import colo_Organizational_Structure_used_with_permission_Jeff_Anderson_png from "Organizational-Structure-used-with-permission-Jeff-Anderson.png";
...
[<Image decoding="async" alt="Organizational Structure used with permission Jeff Anderson" width="1024" height="303" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_Organizational_Structure_used_with_permission_Jeff_Anderson_png} widths={[1024, 300, 768]} />](https://leanpub.com/agileorganizationdesign)

From _[Organizing Toward Agility](https://leanpub.com/agileorganizationdesign)_ by Jeff Anderson, used with permission
...
Culture Change  
Managers in Scrum  
[Scaled Agile Framework](/glossary/safe-scaled-agile-framework)  
[Scaling and Large Teams](/glossary/scaling)