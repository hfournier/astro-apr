...
description: 'The Product Backlog is an ordered list of all the work items or value the Product Owner would like to see the Team work on in the foreseeable future. These items are called Product Backlog Items (PBIs). Scrum Anti-Patterns: Large Product Backlog Resource Links: Make the Product Backlog Deep The Perfect Product Backlog Refactoring — Not ...'
type: glossary
createdAt: 2021-03-23T22:14:03
modifiedAt: 2023-11-24T16:21:58
author: mark-levison
---
