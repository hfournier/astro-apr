...
wpId: 11974
title: 'Story Mapping'
description: 'A Story Map is a way to help visualize the flow or story of a product. Across the top or horizontal axis of the map we place the major steps (often features) in the user''s workflow. Underneath each step or feature are the individual stories that would build out the portion of the product. Story ...'
type: glossary
createdAt: 2021-04-22T21:21:53
modifiedAt: 2024-09-20T17:02:18
author: mark-levison
---

import { Image } from "astro:assets"

import colo_story_mapping_png from "story-mapping.png";
...
<Image decoding="async" alt="story mapping example" width="1173" height="972" sizes="(max-width: 1173px) 100vw, 1173px" src={colo_story_mapping_png} widths={[1173, 300, 1024, 768]} />
...
[Impact Mapping](/glossary/impact-mapping)  
