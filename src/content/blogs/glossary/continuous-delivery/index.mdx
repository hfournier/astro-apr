...
description: 'Continuous Delivery is the game of delivering features to Production whenever a change is made. It shortens the feedback, and even the payment cycle, because you are delivering product more frequently. Because the steps are run multiple times a Sprint, teams need to automate all of the steps along the way to deployment. The application ...'
type: glossary
createdAt: 2021-05-05T20:34:24
