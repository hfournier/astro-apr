...
description: 'Agile Documentation. Is it an oxymoron? The Agile Manifesto says "Working Software over Comprehensive Documentation". It doesn''t say no documentation, and it doesn''t say how much, if at all. In an Agile world, we focus our work on delivering value to the customer, not on chronicling the process. At a high level, some teams maintain a ...'
type: glossary
createdAt: 2022-08-26T15:24:00
