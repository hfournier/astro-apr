...
import colo_self_organization_manager_led_team_jpg from "self-organization-manager-led-team.jpg";
import colo_self_organization_self_org_team_jpg from "self-organization-self-org-team.jpg";
...
**<Image decoding="async" alt="manager led team with central decision making" width="461" height="319" sizes="(max-width: 461px) 100vw, 461px" src={colo_self_organization_manager_led_team_jpg} widths={[860, 300, 768]} />Decentralizing decision making** and putting it into the hands of those who will implement the decisions is the whole point of self-organization. However, many companies claim to embrace self-org, only for someone to say, “Yes, but I still need to make this decision.” Change the default. Most decisions should be left to the team.
...
<Image decoding="async" alt="self organizing team oriented toward a common goal" width="1000" height="800" sizes="(max-width: 1000px) 100vw, 1000px" src={colo_self_organization_self_org_team_jpg} widths={[1000, 300, 768]} />
