...
wpId: 12094
title: 'TDD vs BDD'
description: 'Test Driven Development [TDD] and Behaviour Driven Development [BDD] are often confused because the similarity of their names. TDD is the original technique – "engineering practice where the developer writes their Unit Test case before they write their code". It helps raise quality by ensuring the developer built what they intended to. However, it doesn''t ...'
type: glossary
createdAt: 2021-04-27T18:32:24
