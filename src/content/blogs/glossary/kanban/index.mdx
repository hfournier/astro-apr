...
wpId: 12185
title: 'Kanban'
description: 'Kanban isn''t just a board that you find in JIRA or Trello. It is a method to help improve the flow of work through a system. A kanban board is one way to visualize the work in your system, but use of a board alone will not improve things. Kanban, done as intended, requires discipline ...'
type: glossary
createdAt: 2021-04-30T21:23:22
modifiedAt: 2023-05-24T17:15:06
author: mark-levison
featuredMedia:
  id: 12757
...
import colo_2017CSM_Sample_Scrum_Task_Board_v2_300x300_jpg from "2017CSM-Sample-Scrum-Task-Board-v2-300x300.jpg";
...
<Image decoding="async" alt="Sample Scrum Sprint Backlog - image by Agile Pain Relief Consulting" width="300" height="300" sizes="(max-width: 300px) 100vw, 300px" src={colo_2017CSM_Sample_Scrum_Task_Board_v2_300x300_jpg} widths={[300, 1024, 150, 768, 75, 600, 1320]} />
...
*   [Collaborating with specialized roles using kanban classes of service](https://yuvalyeret.com/collaborating-with-specialized-roles-using-kanban-classes-of-service/)
...
*   [Encouraging Feature-level progress tracking in Kanban](https://yuvalyeret.com/encouraging-feature-level-progress/)
...
[Scrum vs. Kanban](/glossary/scrum-vs-kanban)  
