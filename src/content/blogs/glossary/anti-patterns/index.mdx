...
type: glossary
createdAt: 2021-02-08T17:57:47
modifiedAt: 2024-11-12T20:16:19
author: mark-levison
---

import { Image } from "astro:assets"

import colo_APR_Blog_Illustrations_June2019_Anti_Patterns_v5_300x178_jpg from "APR_Blog-Illustrations_June2019_Anti-Patterns_v5-300x178.jpg";


In software development work, a design pattern is a description of a solution to a recurring problem. It outlines the elements that are necessary to solve the problem, including context and the consequences of certain actions, without prompting the reader to solve the problem a specific way, leaving them with the agency to write code as they see fit.<Image decoding="async" alt="Scrum Anti-Patterns - image by Agile Pain Relief Consulting" width="300" height="178" sizes="(max-width: 300px) 100vw, 300px" src={colo_APR_Blog_Illustrations_June2019_Anti_Patterns_v5_300x178_jpg} widths={[300, 768, 1024, 1416]} />
