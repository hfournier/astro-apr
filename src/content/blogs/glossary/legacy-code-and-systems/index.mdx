...
description: 'Legacy code is often described as code checked into the system without a unit test. A popular definition from Michael Feathers, author of Working Effectively with Legacy Code. The term "legacy code" is commonly used to refer to a codebase that has become increasingly difficult to maintain. There might be a number of reasons: complexity, ...'
type: glossary
createdAt: 2021-05-04T20:45:57
modifiedAt: 2023-05-24T17:15:05
author: mark-levison
---
...
[Approval Tests](/glossary/approval-tests)  
