...
description: 'Definition of Done is the official checklist that Scrum Teams maintain of the qualities they intend their work to achieve. It helps the team assess whether their work is truly completed and deliverable to the client as having added value. It also helps them in Sprint Planning by reminding them of the quality they have committed to achieving, ...'
type: glossary
createdAt: 2023-11-29T12:35:46
modifiedAt: 2024-10-10T14:02:45
author: mark-levison
---

import { Image } from "astro:assets"

import colo_Un_Done_and_Done_jpg from "Un-Done-and-Done.jpg";
...
<Image decoding="async" alt="Undone work vs Truly Done in Scrum" width="800" height="565" sizes="(max-width: 800px) 100vw, 800px" src={colo_Un_Done_and_Done_jpg} widths={[800, 300, 768]} />
...
#### <Image decoding="async" alt="Definition of Done vs. User Stories vs. Acceptance Criteria - image by Agile Pain Relief Consulting" width="503" height="298" sizes="(max-width: 503px) 100vw, 503px" src={colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_A_v2_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
