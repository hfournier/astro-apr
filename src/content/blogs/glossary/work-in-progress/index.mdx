...
description: 'In Scrum, Work in Progress is the batch of User Stories or Product Backlog Items that have been started but not finished. These are also referred to as partially finished items. Work that hasn''t been deployed, shipped, or otherwise delivered to a customer has no real value. Value is only realized when the work is ...'
type: glossary
createdAt: 2021-12-15T12:54:04
modifiedAt: 2023-12-15T17:32:07
author: mark-levison
---

import { Image } from "astro:assets"

import colo_WSOBS_limit_work_in_progress_png from "WSOBS-limit-work-in-progress.png";
...
<Image decoding="async" alt="Limit Work in Progress Kanban board" width="491" height="324" sizes="(max-width: 491px) 100vw, 491px" src={colo_WSOBS_limit_work_in_progress_png} widths={[899, 300, 768]} />
...
[Multitasking](/glossary/multitasking)