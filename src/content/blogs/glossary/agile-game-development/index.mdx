...
description: 'Agile Game Development is different from classical software development. Building a game from scratch will require a broader group of people than we''re used to: Artists (multiple kinds), Animators, Sound Designer, Game Designers, etc. In a normal Scrum team, we expect a high degree of Cross-skilling – e.g. a programmer learning the basics of Quality ...'
type: glossary
createdAt: 2021-06-24T21:43:50
