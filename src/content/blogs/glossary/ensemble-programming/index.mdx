...
description: 'Ensemble Programming (formerly known as Mob Programming) is the logical extension of Pair Programming. The entire team work together to deliver a single Product Backlog Item (or User Story). They work using the same computer, at the same time.  They do all of the steps of their development process together, from requirements -&gt; code -&gt; ...'
type: glossary
createdAt: 2021-05-05T20:36:24
