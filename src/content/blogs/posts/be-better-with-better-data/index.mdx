...
description: 'Data and metrics are not synonymous. Let''s tackle that misunderstanding right out of the gate. Data is a number or set of numbers. "Three days." There. That''s data. Is it useful to you? Of course not, because you have no context to go with it. Metrics is the context and measurement of where, and under ...'
type: post
createdAt: 2021-11-22T20:10:55
modifiedAt: 2022-04-13T15:22:45
author: mark-levison
categories:
  - agile
...
featuredMedia:
  id: 13379
  src: "Example-Data-Team-Morale.png"
  alt: "Example Data - Team Morale"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Example_Data_Team_Morale_1024x534_png from "Example-Data-Team-Morale-1024x534.png";
import colo_Example_Data_Quality_1024x574_jpg from "Example-Data-Quality-1024x574.jpg";
...
<Image decoding="async" alt="Example of data collected to measure team morale presenting results using red-yellow-green colour coding" width="1024" height="534" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_Example_Data_Team_Morale_1024x534_png} widths={[1024, 300, 768, 1178]} />
...
<Image decoding="async" alt="Graph measuring number of defects found in a product over time, measured in weeks." width="1024" height="574" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_Example_Data_Quality_1024x574_jpg} widths={[1024, 300, 768, 1152]} />
