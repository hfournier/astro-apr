---
wpId: 4689
title: 'Kanban Portfolio View – continued'
...
type: post
createdAt: 2015-03-29T18:43:28
modifiedAt: 2022-04-04T03:51:29
author: mark-levison
categories:
  - beyond-scrum
  - kanban
...
import colo_CFD_Lead_Time_Vs_Cycle_Time_png from "CFD-Lead-Time-Vs-Cycle-Time.png";
import colo_CFD_Showing_how_long_it_takes_for_an_item_to_become_part_of_the_Teams_Common_Product_Backlog_png from "CFD-Showing-how-long-it-takes-for-an-item-to-become-part-of-the-Teams-Common-Product-Backlog.png";
import colo_SmallestOnlineBookstore_Portfolio_WithSwimLanes_png from "SmallestOnlineBookstore_Portfolio_WithSwimLanes.png";
...
_(Continued from [Kanban Portfolio view](/blog/kanban-portfolio-view.html "Kanban Portfolio View") and the 3 core rules. This is the conclusion of Part 2 in the [Scrum Alone is Not Enough](/blog/scrum-alone-is-not-enough.html "Scrum Alone is Not Enough") series.)_

## 2\. Limit Work In Progress

We know from [queuing theory](https://availagility.co.uk/2008/10/28/kanban-flow-and-cadence/), psychology of [multi-tasking](https://www.infoq.com/articles/multitasking-problems/), and empirical evidence (_[Rally study](https://www.infoq.com/presentations/agile-quantify/), [my summary](/blog/stable-teams-really-do-matter.html "Stable Teams Really Do Matter") of the Rally Study_) that more Work in Progress means less work gets done overall. **This leads to the second Kanban rule: Limit Your Work in Progress**.
...
The measurements (often shown via a [Cumulative Flow Diagram](https://brodzinski.com/2013/07/cumulative-flow-diagram.html)) show us where our limited improvement energy is most likely to bear fruit.

<Image decoding="async" alt="Kanban Portfolio View - CFD Lead Time Vs Cycle Time" width="790" height="487" sizes="(max-width: 790px) 100vw, 790px" src={colo_CFD_Lead_Time_Vs_Cycle_Time_png} widths={[790, 300, 768]} />
...
<Image decoding="async" alt="Kanban Portfolio View - CFD-Showing-how-long-it-takes-for-an-item-to-become-part-of-the-Teams-Common-Product-Backlog" width="811" height="501" sizes="(max-width: 811px) 100vw, 811px" src={colo_CFD_Showing_how_long_it_takes_for_an_item_to_become_part_of_the_Teams_Common_Product_Backlog_png} widths={[811, 300, 768]} />
...
<Image decoding="async" alt="Kanban Portfolio View - SmallestOnlineBookstore_Portfolio_WithSwimLanes" width="346" height="673" sizes="(max-width: 346px) 100vw, 346px" src={colo_SmallestOnlineBookstore_Portfolio_WithSwimLanes_png} widths={[346, 154]} />
...
Karl Scotland – [Portfolio Kanban](https://availagility.co.uk/2012/06/23/portfolio-kanban/)

Jason Little – [Designing an Enterprise Portfolio Kanban Board](https://www.agilecoach.ca/2013/03/31/designing-an-enterprise-kanban-portfolio-board/)

Pawel Brodzinski – [Portfolio Management with Kanban](https://blog.planview.com/pawel-brodzinski-portfolio-management-with-kanban/) and [Portfolio Kanban – Why Should I Care](https://brodzinski.com/2013/03/portfolio-kanban-why-should-i-care.html)

Sandy Mamoli – [Portfolio Kanban](https://www.infoq.com/presentations/portfolio-kanban/)
...
Image attribution: Agile Pain Relief Consulting. Elements of first image [designed by Freepik](https://www.freepik.com/).