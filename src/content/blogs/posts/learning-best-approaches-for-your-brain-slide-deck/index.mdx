...
description: 'As regular readers of this blog will know I''ve given a talk based on readings in Neuroscience, called "Learning Best Approaches for Your Brain" – several times this year (Agile 2009 and Agile Ottawa). After several requests I''m posting the slide deck (pdf) here – but I''m afraid that it will really only be useful ...'
type: post
createdAt: 2009-11-02T04:24:30
modifiedAt: 2022-03-25T20:28:46
author: mark-levison
categories:
  - books
  - science
featuredMedia:
  id: 10359
  src: "photodune-8185389-the-brain-xs.jpg"
  alt: "Brain - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_8185389_the_brain_xs_jpg from "photodune-8185389-the-brain-xs.jpg";


<Image decoding="async" alt="Brain - image licensed from Photodune" width="414" height="483" sizes="(max-width: 414px) 100vw, 414px" src={colo_photodune_8185389_the_brain_xs_jpg} widths={[414, 257]} />As regular readers of this blog will know I’ve given a talk based on readings in Neuroscience, called “Learning Best Approaches for Your Brain” – several times this year (Agile 2009 and Agile Ottawa). After several requests I’m posting the [slide deck](https://www.dropbox.com/s/l9zch4xigolijb9/Learning%20Best%20Approaches%20for%20your%20Brain.pdf?dl=0) (pdf) here – but I’m afraid that it will really only be useful to the people who attended the talk. Here’s the promo I’ve been using:
