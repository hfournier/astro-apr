...
description: 'No, of course not. So when should your Team start and end Sprints? The usual rules of Scrum apply – ask the Team. Run an experiment. There is an instinctive tendency to want to wrap up things at the end of the work week so we can unplug our brains for the weekend, and start ...'
type: post
createdAt: 2017-10-10T19:11:56
modifiedAt: 2020-01-23T09:05:22
author: mark-levison
categories:
  - agile
  - retrospective
...
featuredMedia:
  id: 8940
  src: "photodune-925282-calendar-xs.jpg"
  alt: "Calendar image licensed from Photodune"
  caption: "Calendar on Isolated White Background"
---

import { Image } from "astro:assets"

import colo_photodune_925282_calendar_xs_jpg from "photodune-925282-calendar-xs.jpg";
...
<Image decoding="async" alt="Calendar image licensed from Photodune" width="400" height="266" sizes="(max-width: 400px) 100vw, 400px" src={colo_photodune_925282_calendar_xs_jpg} widths={[548, 300]} />
