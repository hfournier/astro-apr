...
description: 'What can developers learn from Grocery Stores? Grocery stores seem to have discovered the Theory of Constraints and Self Organize to eliminate bottlenecks.'
type: post
createdAt: 2011-05-04T07:52:53
modifiedAt: 2023-01-30T15:51:42
author: mark-levison
categories:
  - business
  - teams
...
featuredMedia:
  id: 10369
  src: "photodune-4373665-grocery-store-xs.jpg"
  alt: "Grocery store - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_4373665_grocery_store_xs_jpg from "photodune-4373665-grocery-store-xs.jpg";


<Image decoding="async" alt="Grocery store - image licensed from Photodune" width="507" height="394" sizes="(max-width: 507px) 100vw, 507px" src={colo_photodune_4373665_grocery_store_xs_jpg} widths={[507, 300]} />Shopping in our local Grocery Store (Farm Boy) on a recent Saturday made me realize what a good job they do Limiting Work in Progress (WIP) and Self Organizing. Driving into the parking lot with my 4yr old, I was dreading the busyness of the store. When I got in, the place was packed, and trying to manoeuvre even a small cart with a 4yr old driving was quite the experience. I had expected the checkout experience to be easily 10 minutes long, an eternity even with the best behaved child.
