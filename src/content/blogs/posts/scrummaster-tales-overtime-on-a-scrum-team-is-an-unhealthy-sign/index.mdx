...
description: 'A case study of why overtime in an Agile environment doesn''t work. What pitfalls result, and how ScrumMaster and Product Owner can help the team avoid them.'
type: post
createdAt: 2014-02-28T16:39:33
modifiedAt: 2021-12-02T15:22:29
author: mark-levison
categories:
  - scrum-by-example
  - teams
...
featuredMedia:
  id: 10248
  src: "clock-arms-Freepik.jpg"
  alt: "clock-arms-Freepik"
  caption: ""
---

import { Image } from "astro:assets"

import colo_clock_arms_Freepik_jpg from "clock-arms-Freepik.jpg";
import colo_Overtime_small_jpeg from "Overtime-small.jpeg";


<Image decoding="async" alt="clock-arms-Freepik" width="800" height="800" sizes="(max-width: 800px) 100vw, 800px" src={colo_clock_arms_Freepik_jpg} widths={[800, 300, 150, 768]} />
...
<Image decoding="async" alt="Overtime - never hurt anyone" width="600" height="552" sizes="(max-width: 600px) 100vw, 600px" src={colo_Overtime_small_jpeg} widths={[600, 300]} />
