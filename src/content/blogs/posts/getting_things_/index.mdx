...
description: 'Always chasing little scraps of paper around the office? Then consider "My Life Organized" as a task manager. (Short review, I five other tasks to achieve.)'
type: post
createdAt: 2006-12-19T08:51:34
modifiedAt: 2020-02-01T03:06:08
author: mark-levison
categories:
  - science
tags:
...
featuredMedia:
  id: 10496
  src: "paper-balls-xs.jpg"
  alt: "Paper Balls- image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_paper_balls_xs_jpg from "paper-balls-xs.jpg";


<Image decoding="async" alt="Paper Balls- image licensed from Photodune" width="452" height="442" sizes="(max-width: 452px) 100vw, 452px" src={colo_paper_balls_xs_jpg} widths={[452, 300]} />
