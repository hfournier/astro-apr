...
description: 'When last we left our World''s Smallest Online Bookstore team, their Sprint was rocky. To have an effective Sprint Review story, let''s assume that they magically wound back the clock (shazam!) and implemented the changes. As a result, they had the more effective Sprint Planning that we discussed in the last blog post. So let''s ...'
type: post
createdAt: 2021-10-12T17:19:29
modifiedAt: 2022-04-13T15:24:09
author: mark-levison
categories:
  - scrum-by-example
  - sprint
...
featuredMedia:
  id: 13182
  src: "APR-Story-of-a-Sprint-board-12.png"
  alt: "Scrum team meets with shareholders for Sprint Review"
  caption: ""
---

import { Image } from "astro:assets"

import colo_APR_Story_of_a_Sprint_board_12_1024x576_png from "APR-Story-of-a-Sprint-board-12-1024x576.png";
import colo_SbE_WSOBS_buyer_reviews_unverified_buyer_png from "SbE-WSOBS-buyer-reviews-unverified-buyer.png";
import colo_SbE_WSOBS_buyer_reviews_helpful_vote_png from "SbE-WSOBS-buyer-reviews-helpful-vote.png";
...
<Image decoding="async" alt="Illustration of Scrum team meeting with shareholders, with the Product Owner moderating discussion." width="1024" height="576" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_APR_Story_of_a_Sprint_board_12_1024x576_png} widths={[1024, 300, 768, 1536, 1920]} />
...
<Image decoding="async" alt="Placeholder example of an online review with a 1-5 star rating" width="500" height="179" sizes="(max-width: 500px) 100vw, 500px" src={colo_SbE_WSOBS_buyer_reviews_unverified_buyer_png} widths={[500, 300]} />
...
<Image decoding="async" alt="A placeholder example of an online review from a verified buyer of a product" width="500" height="271" sizes="(max-width: 500px) 100vw, 500px" src={colo_SbE_WSOBS_buyer_reviews_helpful_vote_png} widths={[500, 300]} />
