...
featuredMedia:
  id: 10087
  src: "APR_Blog-Illustrations_Nov2019_AcceptanceCriteria_A_v2.jpg"
...
import colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_A_v2_jpg from "APR_Blog-Illustrations_Nov2019_AcceptanceCriteria_A_v2.jpg";
import colo_User_Story_slices_png from "User-Story-slices.png";
import colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_B_v2_jpg from "APR_Blog-Illustrations_Nov2019_AcceptanceCriteria_B_v2.jpg";


<Image decoding="async" alt="Definition of Done vs. User Stories vs. Acceptance Criteria" width="1416" height="840" sizes="(max-width: 1416px) 100vw, 1416px" src={colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_A_v2_jpg} widths={[1416, 300, 1024, 768]} />
...
<Image decoding="async" alt="User Story slices" width="400" height="362" sizes="(max-width: 400px) 100vw, 400px" src={colo_User_Story_slices_png} widths={[400, 300]} />The goals of a User Story are:
...
End-User Documentation has been updated
...
<Image decoding="async" alt="Definition of Done vs. User Stories vs. Acceptance Criteria" width="1416" height="840" sizes="(max-width: 1416px) 100vw, 1416px" src={colo_APR_Blog_Illustrations_Nov2019_AcceptanceCriteria_B_v2_jpg} widths={[1416, 300, 1024, 768]} />
...
_Tap limit is $100  
__Tap not allowed under $10  
__Linked account is checked to ensure the balance is sufficient_
...
Below minimum threshold for tap
...
Purchase over the amount of money in the account
...
Purchase is over the maximum tap limit
