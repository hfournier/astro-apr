...
description: 'Our case study Scrum Team is accumulating Technical Debt and needs to adjust Velocity and review Definition of Done, Unit Testing and Restructuring Legacy Code.'
type: post
createdAt: 2012-02-28T02:10:58
modifiedAt: 2022-04-30T18:49:09
author: mark-levison
categories:
  - books
  - scrum
...
featuredMedia:
  id: 10317
  src: "photodune-9444702-yellow-working-sign-xs.jpg"
  alt: "Yellow vector working sign - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_9444702_yellow_working_sign_xs_jpg from "photodune-9444702-yellow-working-sign-xs.jpg";
import colo_Story_Task_board_png from "Story-Task-board.png";
import colo_Sonar_screenshot_png from "Sonar-screenshot.png";


<Image decoding="async" alt="Yellow vector working sign - image licensed from Photodune" width="447" height="447" sizes="(max-width: 447px) 100vw, 447px" src={colo_photodune_9444702_yellow_working_sign_xs_jpg} widths={[447, 300, 150]} />  
The first law of holes is “When you’re in one, stop digging”. [In the last sprint](/blog/scrummaster-tales-technical-debt-is-slowing-the-team.html) the team discovered that they’re in a hole – in this case they had dug themselves into technical debt.
