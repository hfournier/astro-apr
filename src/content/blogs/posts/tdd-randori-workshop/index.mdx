...
description: 'A few weeks ago I ran my first Coding Dojo/Randori and while the participants learned from the session there had been a few key flaws: The problem was too big The problem was in a domain that was unfamiliar to everyone The facilitator (me) participated too much Ouch. It was true. This week we ran ...'
type: post
createdAt: 2008-10-23T05:18:42
modifiedAt: 2020-01-31T09:06:26
author: mark-levison
categories:
...
[**Scoring Examples**](https://en.wikipedia.org/wiki/Ten-pin_bowling#Scoring) (from wikipedia):  
A **Single** strike:
...
Our retrospective generated a much smaller set of notes this time:  
**Happy**:
