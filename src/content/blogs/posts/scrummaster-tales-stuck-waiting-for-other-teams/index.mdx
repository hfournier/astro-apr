...
description: 'The Scrum team has improved, progress has slowed. How to analyze and identify the bottlenecks between Product Development and Deployment.'
type: post
createdAt: 2014-08-29T08:53:16
modifiedAt: 2022-03-31T19:41:27
author: mark-levison
categories:
  - scrum-by-example
tags:
...
featuredMedia:
  id: 10168
  src: "road-44143_640.png"
  alt: "Speed Bump Sign - free image from Pixabay.com"
  caption: ""
---

import { Image } from "astro:assets"

import colo_road_44143_640_png from "road-44143_640.png";
import colo_ScrumMaster_Tales___Stuck_Waiting_for_Other_Teams_data_table_jpg from "ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_data_table.jpg";
import colo_ScrumMaster_Tales___Stuck_Waiting_for_Other_Teams_CFD_chart_jpg from "ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_CFD_chart.jpg";


### <Image decoding="async" alt="Speed Bump Sign - free image from Pixabay.com" width="480" height="640" sizes="(max-width: 480px) 100vw, 480px" src={colo_road_44143_640_png} widths={[480, 225]} />  
...
<Image decoding="async" alt="ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_data_table" width="661" height="486" sizes="(max-width: 661px) 100vw, 661px" src={colo_ScrumMaster_Tales___Stuck_Waiting_for_Other_Teams_data_table_jpg} widths={[661, 300]} />

From the data we can produce a Cumulative Flow Diagram that looks like this:

<Image decoding="async" alt="ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_CFD_chart" width="549" height="468" sizes="(max-width: 549px) 100vw, 549px" src={colo_ScrumMaster_Tales___Stuck_Waiting_for_Other_Teams_CFD_chart_jpg} widths={[549, 300]} />
