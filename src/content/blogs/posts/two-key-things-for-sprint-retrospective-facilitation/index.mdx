...
type: post
createdAt: 2022-05-10T13:46:21
modifiedAt: 2022-05-10T20:02:06
author: mark-levison
categories:
  - agile
  - retrospective
...
featuredMedia:
  id: 13980
  src: "prateek-katyal-FcdtuGf7TEc-unsplash-scaled.jpg"
  alt: "You Got This sign by Prateek Katyal courtesy of Unsplash"
  caption: ""
---

import { Image } from "astro:assets"

import colo_prateek_katyal_FcdtuGf7TEc_unsplash_683x1024_jpg from "prateek-katyal-FcdtuGf7TEc-unsplash-683x1024.jpg";


<Image decoding="async" alt="You Got This sign by Prateek Katyal courtesy of Unsplash" width="470" height="705" sizes="(max-width: 470px) 100vw, 470px" src={colo_prateek_katyal_FcdtuGf7TEc_unsplash_683x1024_jpg} widths={[683, 200, 768, 1024, 1365]} />Retrospectives are a critical element in Scrum but they won’t work well if your team hates them. A [Sprint Retrospective](/glossary/sprint-retrospective) needs someone to facilitate and keep it on track to encourage effective discussion. It’s more of an art than a science, but these key things will help.
