...
description: 'Smaller stories tend to get more accurate estimates. This is my guidance for new Scrum teams, and ScrumMasters, trying to decide on Story size.'
type: post
createdAt: 2010-09-27T04:18:18
modifiedAt: 2021-11-30T23:37:38
author: mark-levison
categories:
  - agile
  - scrum
...
featuredMedia:
  id: 10384
  src: "photodune-3570112-cutting-xs.jpg"
  alt: "Cutting - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_3570112_cutting_xs_jpg from "photodune-3570112-cutting-xs.jpg";


<Image decoding="async" alt="Story Slicing. Cutting - image licensed from Photodune" width="494" height="404" sizes="(max-width: 494px) 100vw, 494px" src={colo_photodune_3570112_cutting_xs_jpg} widths={[494, 300]} />  
When Agile/Scrum Trainers teach about new teams about User Stories, we usually talk about Bill Wake’s [INVEST](https://xp123.com/xplor/xp0308/index.shtml) criteria, which includes Small:
