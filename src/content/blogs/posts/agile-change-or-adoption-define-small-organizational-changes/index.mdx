...
type: post
createdAt: 2016-12-15T01:23:10
modifiedAt: 2022-04-30T18:47:34
author: mark-levison
categories:
  - agile
  - backlog-refinement
...
import colo_Be_Always_Changing_execute_changes_jpg from "Be-Always-Changing-execute-changes.jpg";
import colo_improvementstorytemplateB_1024x628_png from "improvementstorytemplateB-1024x628.png";
import colo_improvementstorytemplateA_1024x636_png from "improvementstorytemplateA-1024x636.png";


<Image decoding="async" alt="Be Always Changing - execute changes - image by Agile Pain Relief Consulting" width="700" height="500" sizes="(max-width: 700px) 100vw, 700px" src={colo_Be_Always_Changing_execute_changes_jpg} widths={[700, 300]} />(Continued from _Agile Change or Adoption Always Starts with Why_ : [1](/blog/agile-change-or-adoption-always-starts-with-why.html) , [2](/blog/agile-change-or-adoption-the-steps-to-go-from-why-to-how.html) , [3](/blog/agile-change-or-adoption-sense-your-current-culture.html) , [4](/blog/agile-change-or-adoption-create-a-vision.html) , [5](/blog/agile-change-or-adoption-turn-vision-into-strategy.html) )
...
[  
](https://www.innovel.net/wp-content/uploads/improvementstorytemplateB.png)[<Image decoding="async" alt="Sample Improvement Story Template - by Robin Dymond" width="1024" height="628" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_improvementstorytemplateB_1024x628_png} widths={[1024, 300, 768, 1300]} />](https://innovel.net/wp-content/uploads/improvementstorytemplateB.png)Template A is likely more familiar to most people who are using User Stories.

[<Image decoding="async" alt="Sample Improvement Story Template - by Robin Dymond" width="1024" height="636" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_improvementstorytemplateA_1024x636_png} widths={[1024, 300, 768, 1303]} />](https://innovel.net/wp-content/uploads/improvementstorytemplateA.png)
...
“Be Always Changing” image attribution: Agile Pain Relief Consulting  
