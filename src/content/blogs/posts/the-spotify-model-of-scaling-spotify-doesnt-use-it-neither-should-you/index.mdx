...
description: 'The "Spotify Model" probably isn''t a model and definitely isn''t what is currently practiced at Spotify today. (Some suggest it never was.) The below image was made famous in a video by Henrik Kniberg, where he explains how work was organized into Squads, Tribes, and Guilds. Many people see the structure and try to mimic ...'
type: post
createdAt: 2023-10-24T16:14:58
modifiedAt: 2023-10-24T16:16:59
author: mark-levison
categories:
  - agile
  - business
...
featuredMedia:
  id: 15639
  src: "spotify-model-meme.png"
  alt: "spotify model meme"
  caption: "Figure 2  from: https://medium.com/serious-scrum/you-want-to-adopt-the-spotify-model-i-dont-think-it-means-what-you-think-it-means-7df4316081f"
---

import { Image } from "astro:assets"

import colo_spotify_scaling_model_credit_Kniberg_Ivarsson_png from "spotify-scaling-model-credit-Kniberg-Ivarsson.png";
import colo_spotify_model_meme_png from "spotify-model-meme.png";
...
<Image decoding="async" alt="Spotify Scaling model image, credit Henrik Kniberg and Anders Ivarsson" width="974" height="583" sizes="(max-width: 974px) 100vw, 974px" src={colo_spotify_scaling_model_credit_Kniberg_Ivarsson_png} widths={[974, 300, 768]} />

Figure 1 – The famous picture from: https://blog.crisp.se/wp-content/uploads/2012/11/SpotifyScaling.pdf
...
<Image decoding="async" alt="spotify model meme" width="749" height="560" sizes="(max-width: 749px) 100vw, 749px" src={colo_spotify_model_meme_png} widths={[974, 300, 768]} />

Figure 2 from: https://medium.com/serious-scrum/you-want-to-adopt-the-spotify-model-i-dont-think-it-means-what-you-think-it-means-7df4316081f
