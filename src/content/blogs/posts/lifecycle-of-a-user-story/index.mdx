...
description: 'Agile User Stories. Answers to: What are they? Where do they come from? When are they created? How are they prioritized? Practical examples.'
type: post
createdAt: 2013-11-04T08:57:14
modifiedAt: 2022-04-30T15:21:39
author: mark-levison
categories:
  - scrum-by-example
  - user-stories
...
import colo_LifeCycle_png from "LifeCycle.png";


<Image decoding="async" alt="Lifecycle image via Wikimedia Commons" width="313" height="298" sizes="(max-width: 313px) 100vw, 313px" src={colo_LifeCycle_png} widths={[313, 300]} />  
[User Stories](/blog/definition-of-done-user-stories-acceptance-criteria.html) are often used as a lightweight form of Agile requirement. Their goal is to replace heavy weight-specification documents with “a Card, a Conversation and a Confirmation”. When people first discover User Stories it’s hard to see how they work because we often take a static viewpoint – i.e. we only see them at Release Planning or during implementation. We’re left with many questions: Where do User Stories come from? When are they created? Who is involved in their creation?
