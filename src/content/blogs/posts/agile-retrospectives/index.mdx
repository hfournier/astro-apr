...
description: 'What is the difference between an Agile Retrospective and a Post Mortem? Retrospectives are the foundation of Continuous Improvement and Short Feedback loops.'
type: post
createdAt: 2020-07-14T09:56:29
modifiedAt: 2022-04-13T15:26:34
author: mark-levison
categories:
  - agile
  - retrospective
...
featuredMedia:
  id: 11025
  src: "APR-BlogIllustration_July2020_AgileRetrospectives_v1.jpg"
  alt: "Agile and Scrum Retrospectives - image by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_APR_BlogIllustration_July2020_AgileRetrospectives_v1_jpg from "APR-BlogIllustration_July2020_AgileRetrospectives_v1.jpg";
import colo_Retrospective_Structure_Chris_Smith_jpg from "Retrospective-Structure-Chris-Smith.jpg";


<Image decoding="async" alt="Agile and Scrum Retrospectives" width="1416" height="840" sizes="(max-width: 1416px) 100vw, 1416px" src={colo_APR_BlogIllustration_July2020_AgileRetrospectives_v1_jpg} widths={[1416, 300, 1024, 768]} />  
...
<Image decoding="async" alt="Sprint Retrospective Structure" width="1109" height="716" sizes="(max-width: 1109px) 100vw, 1109px" src={colo_Retrospective_Structure_Chris_Smith_jpg} widths={[1109, 300, 1024, 768]} />
...
\[1\] _The Fifth Discipline: The Art & Practice of The Learning Organization_ by Peter Senge [https://www.amazon.com/Fifth-Discipline-Practice-Learning-Organization/dp/0385517254/](https://www.amazon.com/Fifth-Discipline-Practice-Learning-Organization/dp/0385517254/)  
\[2\] [https://en.wikipedia.org/wiki/You\_can%27t\_have\_your\_cake\_and\_eat\_it](https://en.wikipedia.org/wiki/You_can%27t_have_your_cake_and_eat_it)  
\[3\] “8 Ground Rules for Great Meetings” by Roger Schwarz – [https://hbr.org/2016/06/8-ground-rules-for-great-meetings](https://hbr.org/2016/06/8-ground-rules-for-great-meetings)  
\[4\] Curiously Roger Schwarz also recommends the opposite: [http://www.schwarzassociates.com/managing-performance/why-facilitators-and-consultants-shouldnt-ask-groups-to-develop-their-own-ground-rules/](http://www.schwarzassociates.com/managing-performance/why-facilitators-and-consultants-shouldnt-ask-groups-to-develop-their-own-ground-rules/)  
\[5\] These are originally from “8 Ground Rules for Great Meetings” by Roger Schwarz – [https://hbr.org/2016/06/8-ground-rules-for-great-meetings](https://hbr.org/2016/06/8-ground-rules-for-great-meetings)  
\[6\] Original idea from Peter Stevens  
\[7\] Activities where team members contribute their information silently and at the same time (e.g. writing on post-it notes and sticking them up when everyone is done).
