...
featuredMedia:
  id: 14173
  src: "decision-making-tools.jpg"
  alt: "decision-making techniques and tools matter"
  caption: ""
---

import { Image } from "astro:assets"

import colo_decision_making_tools_jpg from "decision-making-tools.jpg";
import colo_fist_to_five_rapid_voting_1024x317_png from "fist-to-five-rapid-voting-1024x317.png";
import colo_dot_voting_1024x683_jpg from "dot-voting-1024x683.jpg";


<Image decoding="async" alt="decision-making techniques and tools matter" width="400" height="533" sizes="(max-width: 400px) 100vw, 400px" src={colo_decision_making_tools_jpg} widths={[600, 225]} />
...
A “no” vote, will block consensus

No support, but won’t block. Will discuss and suggest changes

Moderately comfortable, Discuss minor issues

Not in total agreement but comfortable to let the decision pass

Good idea, will work for it

Great idea, complete agreement, support it fully

<Image decoding="async" alt="fist to five rapid voting" width="1024" height="317" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_fist_to_five_rapid_voting_1024x317_png} widths={[1024, 300, 768, 1027]} />
...
<Image decoding="async" alt="dot voting" width="687" height="458" sizes="(max-width: 687px) 100vw, 687px" src={colo_dot_voting_1024x683_jpg} widths={[1024, 300, 768, 1536, 1800]} />The above example was used by a group at an organizational retrospective to decide what items they should address.
