...
description: 'What does it take to be a great ScrumMaster? When I was in my early years as a Scrum Trainer, circa 2011, it was noticeable to me that while there was a plethora of content out there explaining the role of the ScrumMaster and what qualities you want in a person for the role, there ...'
type: post
createdAt: 2018-08-24T00:00:28
modifiedAt: 2024-02-27T14:43:18
author: mark-levison
categories:
  - scrum
  - scrum-by-example
...
featuredMedia:
  id: 8911
  src: "Scrum-by-Example-Characters.jpg"
  alt: "Scrum by Example Team Member personas - image owned by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Scrum_by_Example_Characters_1024x711_jpg from "Scrum-by-Example-Characters-1024x711.jpg";
...
<Image decoding="async" alt="A lineup of characters used in the Scrum By Example series" width="1024" height="711" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_Scrum_by_Example_Characters_1024x711_jpg} widths={[1024, 300, 768, 1944]} />
