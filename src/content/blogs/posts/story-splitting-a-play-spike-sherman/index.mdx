...
<Image decoding="async" alt="Story Splitting Flowchart by Richard Lawrence" width="645" height="254" sizes="(max-width: 645px) 100vw, 645px" src={colo_Story_Splitting_Flowchart_jpeg} widths={[645, 300]} />
<Image decoding="async" alt='Story Splitting – a Play – “Spike Sherman"' width="341" height="300" sizes="(max-width: 341px) 100vw, 341px" src={colo_DSC01970_jpg} widths={[341, 300]} />
