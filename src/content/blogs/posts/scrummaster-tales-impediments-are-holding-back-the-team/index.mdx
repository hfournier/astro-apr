...
description: 'Our case study Scrum team learns than impediments are anything stopping the team from delivering value. Resolve problems faster by making subtle issues visible.'
type: post
createdAt: 2011-12-07T05:57:03
modifiedAt: 2020-01-30T09:56:48
author: mark-levison
categories:
  - scrum-by-example
tags:
...
featuredMedia:
  id: 10235
  src: "stop-sign-FreePik.jpg"
  alt: "Stop Sign. Image by FreePik"
  caption: ""
---

import { Image } from "astro:assets"

import colo_stop_sign_FreePik_jpg from "stop-sign-FreePik.jpg";


<Image decoding="async" alt="Stop Sign. Image by FreePik" width="431" height="441" sizes="(max-width: 431px) 100vw, 431px" src={colo_stop_sign_FreePik_jpg} widths={[431, 293]} />  
