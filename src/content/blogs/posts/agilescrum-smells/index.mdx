...
description: 'Smells are a series of simple patterns in Scrums that describe a problem, which can then lead to potential solutions.'
type: post
createdAt: 2008-06-17T05:10:39
modifiedAt: 2022-01-31T21:31:31
author: mark-levison
categories:
  - scrum
...
import colo_sniffing_dog_xs_jpg from "sniffing-dog-xs.jpg";


<Image decoding="async" alt="Sniffing dog- image licensed from Photodune" width="548" height="365" sizes="(max-width: 548px) 100vw, 548px" src={colo_sniffing_dog_xs_jpg} widths={[548, 300]} />  
