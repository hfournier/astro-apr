...
description: '(Presented as Part 4 in the Scrum Alone is Not Enough series, and accompanied by this worked example of Organizational Improvement in WorldsSmallestOnlineBookstore.) If Agile change initiatives don''t produce at least the doubling in productivity that is possible, it''s often because Scrum is used as a wrapper around the current state of work, but the organization ...'
type: post
createdAt: 2015-09-14T19:37:00
modifiedAt: 2023-07-21T14:14:12
author: mark-levison
categories:
  - beyond-scrum
  - kanban
