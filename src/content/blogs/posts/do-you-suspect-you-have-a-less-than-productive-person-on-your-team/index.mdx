...
description: 'In the past couple of days on the Scrum Development mailing list an interesting thread has developed around what to do with a poor-performing team member. Too my mind there have been a number of key takeaways: Be very careful about the language you use: Strong language implies prejudice and assumptions. Reset use a Beginner''s ...'
type: post
createdAt: 2009-01-06T23:30:30
modifiedAt: 2022-04-27T04:21:24
author: mark-levison
categories:
  - software-development
featuredMedia:
  id: 10434
  src: "typewriter-xs.jpg"
  alt: "typewriter - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_typewriter_xs_jpg from "typewriter-xs.jpg";


<Image decoding="async" alt="typewriter - image licensed from Photodune" width="548" height="365" sizes="(max-width: 548px) 100vw, 548px" src={colo_typewriter_xs_jpg} widths={[548, 300]} />  
