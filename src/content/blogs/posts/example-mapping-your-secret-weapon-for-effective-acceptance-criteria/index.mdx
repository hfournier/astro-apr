...
description: 'Example mapping is a collaborative technique for a team to take a User Story (or PBI) and have a deeper conversation to clarify their understanding of it. The conversation generates the Acceptance Criteria. (Acceptance Criteria is the generic idea – Example Mapping is the approach I generally recommend.) We need an example. Let''s pretend that we''re building ...'
type: post
createdAt: 2024-11-12T12:42:46
modifiedAt: 2024-11-12T16:21:46
author: mark-levison
categories:
  - uncategorized
featuredMedia:
  id: 16492
  src: "Example-Mapping.jpg"
  alt: "Example Mapping sample"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Example_Mapping_jpg from "Example-Mapping.jpg";
...
<Image decoding="async" alt="Example Mapping sample" width="800" height="600" sizes="(max-width: 800px) 100vw, 800px" src={colo_Example_Mapping_jpg} widths={[800, 300, 768]} />
...
Original idea from [Matt Wynne](https://cucumber.io/blog/bdd/example-mapping-introduction/).  
_(Bonus: I learned that Friends episodes can be named, “The one where…”)_

### References

[Acceptance Criteria](/glossary/acceptance-criteria)  
[Behaviour Driven Development (BDD)](/glossary/behaviour-driven-development)