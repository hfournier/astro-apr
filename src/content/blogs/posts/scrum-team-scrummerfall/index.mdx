...
description: 'Is your Scrum team struggling with questions about who owns quality? Is testing way behind development? Are team members claiming no time for retrospective because they''re focused on delivery? They might be victims of what some call Scrummerfall, or Mini Waterfall. Let''s use our fictional World''s Smallest Online Bookstore (WSOBS) Scrum team to explore what ...'
type: post
createdAt: 2024-02-27T14:41:55
modifiedAt: 2024-02-27T15:45:24
author: mark-levison
categories:
  - scrum-by-example
tags:
...
featuredMedia:
  id: 16067
  src: "Staggered-Sprint-Starting-Point.jpg"
  alt: "Scrummerfall Staggered Sprint Starting Point"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Sprint_Backlog_SbE_Scrumerfall_example_jpg from "Sprint-Backlog-SbE-Scrumerfall-example.jpg";
...
Paula – Product Owner of Steve’s Team  
Tonia – Quality Assurance specialist  
Brad – Business Analyst  
...
<Image decoding="async" alt="Sprint Backlog - Scrum by Example Scrummerfall example" width="705" height="765" sizes="(max-width: 705px) 100vw, 705px" src={colo_Sprint_Backlog_SbE_Scrumerfall_example_jpg} widths={[705, 276]} />
...
**Not understanding the value of Sprint Retrospectives is, sadly, not a new issue with these team members.  
Read also: [Same Old Song in Sprint Retrospective](/blog/same-old-song-in-sprint-retrospective.html).**
...
<Image decoding="async" alt="Scrummerfall Staggered Sprint Starting Point" width="1024" height="613" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_Staggered_Sprint_Starting_Point_1024x613_jpg} widths={[1024, 300, 768, 1536, 2048]} />
...
[Quality Assurance in Scrum](/glossary/quality-assurance-in-scrum)