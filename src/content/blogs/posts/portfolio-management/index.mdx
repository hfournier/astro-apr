...
description: '(Presented as Part 3 in the Scrum Alone is Not Enough series.) As mentioned in the introduction to the Scrum Alone is Not Enough series, Scrum is simply the framework and, to work best, other tools and patterns need to be incorporated to build the most effective systems. Portfolio Management is one of those things ...'
type: post
createdAt: 2015-06-14T19:16:23
modifiedAt: 2022-03-31T20:19:40
author: mark-levison
categories:
  - beyond-scrum
  - kanban
...
import colo_scrum_alone_not_enough_portfolio_management_jpg from "scrum-alone-not-enough-portfolio-management.jpg";
import colo_SmallestOnlineBookstore_Portfolio_before_review_meeting_jpg from "SmallestOnlineBookstore_Portfolio-before-review-meeting.jpg";


<Image decoding="async" alt="Beyond Scrum: Scrum Alone Is Not Enough - portfolio management" width="1403" height="1350" sizes="(max-width: 1403px) 100vw, 1403px" src={colo_scrum_alone_not_enough_portfolio_management_jpg} widths={[1403, 300, 1024, 768]} />

(_Presented as Part 3 in the [Scrum Alone is Not Enough series](/blog/scrum-alone-is-not-enough.html)._)
...
*   The organization has already visualized the state of the work using a [Portfolio Kanban Board](/blog/kanban-portfolio-view.html) or similar tool
...
[<Image decoding="async" alt="SmallestOnlineBookstore_Portfolio-before-review-meeting" width="1320" height="554" sizes="(max-width: 1320px) 100vw, 1320px" src={colo_SmallestOnlineBookstore_Portfolio_before_review_meeting_jpg} widths={[1320, 300, 1024, 768]} />](/wp-content/uploads/2020/01/SmallestOnlineBookstore_Portfolio-before-review-meeting.jpg)
...
_Will the current work around Gift Cards, Premium Shipping, and Book Returns likely be sufficient?_
...
But as you can imagine, when a group hands out a budget envelope, they want to believe that they will get value in return. This can sometimes cause conflict in the case of idle workers. We will address that in [the next post in this series](/blog/portfolio-management-idle-teams.html).

Resource: [Map Your Current Process with Kanban](https://blog.planview.com/6-benefits-of-kanban-for-project-management/)
