...
description: 'In Scrum, Product Backlog Refinement is an essential meeting of the Product Owner and the Development Team to gain clarity and a shared understanding of what needs to be done through discussion and sharing of ideas. The following is a guide example of how to run an effective Product Backlog Refinement meeting. We know that many people learn ...'
type: post
createdAt: 2023-12-12T14:00:51
modifiedAt: 2024-02-07T20:03:08
author: mark-levison
categories:
  - backlog-refinement
  - scrum-by-example
...
featuredMedia:
  id: 8876
  src: "AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_B_v1.png"
  alt: "Scrum by Example - Product Backlog Refinement in Action- image owned by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_A_v1_1024x607_png from "AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_A_v1-1024x607.png";
import colo_AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_B_v1_1024x607_png from "AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_B_v1-1024x607.png";


_In Scrum, [**Product Backlog Refinement**](/glossary/product-backlog-refinement) is an essential meeting of the Product Owner and the Development Team to gain clarity and a shared understanding of what needs to be done through discussion and sharing of ideas. The following is a guide example of how to run an effective Product Backlog Refinement meeting. We know that many people learn more effectively by example, so the story comes first, using our fictional World’s Smallest Online Bookstore (WSOBS) Scrum team. If you’re in a rush and just need a clear definition and facilitation trick, scroll to the end, or review the general information in the framed areas._
...
<Image decoding="async" alt="A Product Backlog Refinement meeting is where the Product Owner and the Development Team discuss the items at the top of the Product Backlog." width="1024" height="607" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_A_v1_1024x607_png} widths={[1024, 300, 768, 1416]} />
...
<Image decoding="async" alt="Backlog Refinement Meeting Agenda in Action" width="1024" height="607" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_B_v1_1024x607_png} widths={[1024, 300, 768, 1416]} />  
...
\[1\] Many developers complain that Backlog Refinement interrupts them doing valuable work. We sidestep that problem if scheduled right after lunch or at some other time when they’ve already been interrupted. Key point: decide the time with the team.  
