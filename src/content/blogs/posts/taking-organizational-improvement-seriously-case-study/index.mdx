...
description: '(Presented as an accompanying case study to Part 4 in the Scrum Alone is Not Enough series.) In the previous post, we discussed how it''s not enough to practice Scrum at the Team level and expect that it will solve all problems. Senior Management has to get involved for real Agile change to happen and ...'
type: post
createdAt: 2015-11-09T02:12:02
modifiedAt: 2022-04-13T00:19:05
author: mark-levison
categories:
  - beyond-scrum
  - kanban
...
featuredMedia:
  id: 10148
  src: "scrum-alone-not-enough-organizational-improvement.jpg"
  alt: "Beyond Scrum: Scrum Alone Is Not Enough - Organizational Improvement"
  caption: "Original background vector elements designed by Freepik.com. Adaptation by Agile Pain Relief Consulting"
---

import { Image } from "astro:assets"

import colo_scrum_alone_not_enough_organizational_improvement_jpg from "scrum-alone-not-enough-organizational-improvement.jpg";
import colo_Regression_Runtime_in_Days_jpg from "Regression-Runtime-in-Days.jpg";
import colo_LongRegressionCycle_png from "LongRegressionCycle.png";
import colo_PO_cant_stay_focused_jpg from "PO-cant-stay-focused.jpg";


<Image decoding="async" alt="Beyond Scrum: Scrum Alone Is Not Enough" width="1403" height="1350" sizes="(max-width: 1403px) 100vw, 1403px" src={colo_scrum_alone_not_enough_organizational_improvement_jpg} widths={[1403, 300, 1024, 768]} />
...
<Image decoding="async" alt="Regression Runtime in Days" width="617" height="362" sizes="(max-width: 617px) 100vw, 617px" src={colo_Regression_Runtime_in_Days_jpg} widths={[617, 300]} />
...
<Image decoding="async" alt="Long Regression Cycle Casual Loop Diagram" width="1093" height="887" sizes="(max-width: 1093px) 100vw, 1093px" src={colo_LongRegressionCycle_png} widths={[1093, 300, 1024, 768]} />
...
<Image decoding="async" alt="Product Owner Can't Stay Focused" width="614" height="497" sizes="(max-width: 614px) 100vw, 614px" src={colo_PO_cant_stay_focused_jpg} widths={[614, 300]} />
