...
description: 'The story of an Agile/Scrum Team and the problems they run into. In this episode the ScrumMaster spots the number of interruptions from outside the team...'
type: post
createdAt: 2011-10-13T00:12:03
modifiedAt: 2023-05-16T16:10:00
author: mark-levison
categories:
  - scrum
  - scrum-by-example
...
featuredMedia:
  id: 10342
  src: "photodune-2976647-isolated-yellow-driving-warning-sign-xs.jpg"
  alt: "yellow road warning sign - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_2976647_isolated_yellow_driving_warning_sign_xs_jpg from "photodune-2976647-isolated-yellow-driving-warning-sign-xs.jpg";


<Image decoding="async" alt="yellow road warning sign - image licensed from Photodune" width="336" height="595" sizes="(max-width: 336px) 100vw, 336px" src={colo_photodune_2976647_isolated_yellow_driving_warning_sign_xs_jpg} widths={[336, 169]} />  
...
Once Steve noticed the issue he mentioned into a standup and asked people to start tracking what sort of interruptions they had. In the retrospective the team discussed sources of interruptions (again using a [timeline](https://www.energizedwork.com/weblog/2006/10/timeline-retrospective) as reminder).
