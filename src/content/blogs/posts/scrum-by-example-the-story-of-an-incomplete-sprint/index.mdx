...
featuredMedia:
  id: 8873
  src: "APR_Blog-Illustrations_April2019_TooMuchWIP_Panel2.jpg"
  alt: "Scrum by Example – The Story of an Incomplete Sprint- image owned by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_APR_Blog_Illustrations_April2019_TooMuchWIP_Panel1_1024x607_jpg from "APR_Blog-Illustrations_April2019_TooMuchWIP_Panel1-1024x607.jpg";
import colo_APR_Blog_Illustrations_April2019_TooMuchWIP_Panel2_1024x607_jpg from "APR_Blog-Illustrations_April2019_TooMuchWIP_Panel2-1024x607.jpg";
import colo_APR_Blog_Illustrations_April2019_TooMuchWIP_Panel3_1024x607_jpg from "APR_Blog-Illustrations_April2019_TooMuchWIP_Panel3-1024x607.jpg";
...
<Image decoding="async" alt="Scrum by Example – The Story of an Incomplete Sprint" width="1024" height="607" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_APR_Blog_Illustrations_April2019_TooMuchWIP_Panel1_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
...
“Add my book to my shopping cart” was clearly not ready. In the meantime, the other, smaller User Stories were piling up in front of Tonia, leaving her unable to keep up with testing.<Image decoding="async" alt="Scrum by Example – The Story of an Incomplete Sprint" width="1024" height="607" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_APR_Blog_Illustrations_April2019_TooMuchWIP_Panel2_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
...
<Image decoding="async" alt="Scrum by Example – The Story of an Incomplete Sprint" width="1024" height="607" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_APR_Blog_Illustrations_April2019_TooMuchWIP_Panel3_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
...
\[1\] Mark’s note: This is not a good thing – having Team members doing work outside of the boundaries of the Team is usually a sign of some kind of dysfunction or larger problem in how Scrum has been implemented, as is the case here.  
\[2\] Lean calls Work In Progress “Excess Inventory” – [https://en.wikipedia.org/wiki/The\_Toyota\_Way](https://en.wikipedia.org/wiki/The_Toyota_Way)  
\[3\] Caveat – Planning Poker and Story Point estimation aren’t part of Scrum but they’re often useful techniques that are used in conjunction with Scrum.  
\[4\] Knowledge work is where thinking is the largest part of the work: [https://en.wikipedia.org/wiki/Knowledge\_worker](https://en.wikipedia.org/wiki/Knowledge_worker)
