...
description: 'Miško Hevery a Google Best Practices Coach gives an excellent talk what Clean Code. He''s pitching writing testable code, pointing out problems that make code difficult to test. If you''re already practicing TDD there will be very little new here. But if you''re struggling either not convinced that TDD is worth the learning curve or ...'
type: post
createdAt: 2008-11-05T02:59:04
modifiedAt: 2008-11-05T02:59:04
author: mark-levison
categories:
