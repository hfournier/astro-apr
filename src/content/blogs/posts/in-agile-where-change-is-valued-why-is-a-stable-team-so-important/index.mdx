...
description: 'A stable team is one in which team membership doesn''t change often and, instead, is consistent over time. Why should we care? Isn''t Scrum like basketball where you can change the players on the court anytime there is an interruption? Let''s find out... High-performing teams —or teams that gets stuff done with insanely high quality— ...'
type: post
createdAt: 2023-10-18T16:52:15
modifiedAt: 2023-11-20T22:20:07
author: mark-levison
categories:
  - scrum
  - teams
featuredMedia:
  id: 8880
  src: "Unstable-Teams-Tuckman-stages.jpg"
...
import colo_Tuckmans_Model_jpg from "Tuckmans-Model.jpg";
import colo_Unstable_Teams_Tuckman_stages_jpg from "Unstable-Teams-Tuckman-stages.jpg";
...
<Image decoding="async" alt="Tuckman's Model of Team Formation" width="419" height="357" sizes="(max-width: 419px) 100vw, 419px" src={colo_Tuckmans_Model_jpg} widths={[419, 300]} />
...
<Image decoding="async" alt="Tuckman's stages of team formation in Unstable Teams- image owned by Agile Pain Relief Consulting" width="463" height="295" sizes="(max-width: 463px) 100vw, 463px" src={colo_Unstable_Teams_Tuckman_stages_jpg} widths={[463, 300]} />
...
*   **Matrix organization**  
    When team members report to different managers, each manager will have different agendas/needs. As a result, team members may be moved, even when a more elegant solution might work and allow them to remain in the team.
