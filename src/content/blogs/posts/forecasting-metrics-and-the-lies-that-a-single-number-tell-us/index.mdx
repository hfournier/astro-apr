...
type: post
createdAt: 2016-07-11T19:52:35
modifiedAt: 2021-01-21T16:22:54
author: mark-levison
categories:
  - agile
  - beyond-scrum
...
featuredMedia:
  id: 9799
  src: "photodune-1447482-measures-xs.jpg"
  alt: "original image by AGorohov: Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Forecasting_Metrics_burndown_e1468266364183_jpg from "Forecasting-Metrics-burndown-e1468266364183.jpg";
...
<Image decoding="async" alt="Image by Agile Pain Relief Consulting" width="431" height="369" sizes="(max-width: 431px) 100vw, 431px" src={colo_Forecasting_Metrics_burndown_e1468266364183_jpg} widths={[431, 300]} />
...
![Forecasting Metrics confidence line](Forecasting-Metrics-confidence-line.jpg)With five Sprints to go, we have a clear picture of where in the product backlog we will likely get.
...
\[2\] Even elections are now forecast with ranges by the better forecasters: Eric Grenier: [https://www.threehundredeight.com/2015/10/final-federal-projection-likely-liberal.html](https://www.threehundredeight.com/2015/10/final-federal-projection-likely-liberal.html)
