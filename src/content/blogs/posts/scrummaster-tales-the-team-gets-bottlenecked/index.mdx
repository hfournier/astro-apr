...
description: 'A ScrumMaster Tales case study of an Agile team that relies on one specialized developer for all tasks, which becomes a bottleneck for the sprint.'
type: post
createdAt: 2012-02-07T02:52:35
modifiedAt: 2022-03-25T20:39:49
author: mark-levison
categories:
  - scrum-by-example
tags:
...
featuredMedia:
  id: 10326
  src: "photodune-510956-bottle-xs.jpg"
  alt: "Old fashioned glass bottle with cork stopper. - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_510956_bottle_xs_jpg from "photodune-510956-bottle-xs.jpg";


<Image decoding="async" alt="Old fashioned glass bottle with cork stopper. - image licensed from Photodune" width="365" height="548" sizes="(max-width: 365px) 100vw, 365px" src={colo_photodune_510956_bottle_xs_jpg} widths={[365, 200]} />It’s day four of the sprint and ScrumMaster Steve is studying the Story + Task wall to see how the sprint is progressing. After a few minutes he sees three things that standout:
