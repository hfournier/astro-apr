...
description: 'How to introduce the basic concepts of Scrum in 60 minutes? I invited teams to create Children''s Books of the Goldilocks story.'
type: post
createdAt: 2011-11-07T08:46:39
modifiedAt: 2023-05-30T15:59:59
author: mark-levison
categories:
  - scrum
tags:
...
import colo_2011_11_03_11_16_49_jpg from "2011-11-03-11.16.49.jpg";


## <Image decoding="async" alt="Scrum training session run by Certified Scrum Trainer Mark Levison" width="640" height="397" sizes="(max-width: 640px) 100vw, 640px" src={colo_2011_11_03_11_16_49_jpg} widths={[640, 300]} />  
_2011 Session_
...
![Learning Scrum Through Games](wpid-LearningScrumThroughGamesSuccess-2012-11-27-07-30.jpg)
...
*   Ask the Product Owner Questions – in Ottawa only one team did this. As a result many teams were surprised when it turned out that a nine-page comic book was the only thing I accepted as complete.![Learning Scrum Through Games](wpid-ScrumThroughGames-2012-11-27-07-30.jpg)
...
[Intro to Scrum with Games Backlog and Schedule](/wp-content/uploads/2020/01/Intro-to-Scrum-with-Games-Backlog-and-Schedule.pdf) (pdf)  
[Introduction to Scrum Concepts](/wp-content/uploads/2020/01/Introduction-to-Scrum-Concepts.pdf) (pdf)
