...
description: 'Ok so I''m about a month behind. Over on Coding Horror Jeff Atwood asked "I can''t help wondering if pair programming is nothing more than code review on steroids". In a word ‘No''. Code Reviews ...(and I''ve done many) are static. One or more people study the code often long after it was written and ...'
type: post
createdAt: 2007-12-14T01:11:45
modifiedAt: 2022-04-08T19:19:29
author: mark-levison
categories:
  - software-development
featuredMedia:
  id: 10329
  src: "casual-executives-working-together-at-a-meeting-with-laptop-xs.jpg"
...
import colo_casual_executives_working_together_at_a_meeting_with_laptop_xs_jpg from "casual-executives-working-together-at-a-meeting-with-laptop-xs.jpg";


<Image decoding="async" alt="Portrait of casual executives working together at a meeting with laptop. - image licensed from Photodune" width="548" height="365" sizes="(max-width: 548px) 100vw, 548px" src={colo_casual_executives_working_together_at_a_meeting_with_laptop_xs_jpg} widths={[548, 300]} />  
Ok so I’m about a month behind. Over on [Coding Horror Jeff Atwood](https://blog.codinghorror.com/pair-programming-vs-code-reviews/) asked “**I can’t help wondering if pair programming is nothing more than code review on steroids**”. In a word ‘No’.
