...
description: 'Clearing up questions and confusions related to INVEST criteria, story splitting, and scope creep in an Agile development sprint.'
type: post
createdAt: 2010-12-03T02:09:44
modifiedAt: 2022-12-12T14:47:10
author: mark-levison
categories:
  - agile
  - scrum
...
featuredMedia:
  id: 8944
  src: "photodune-8431094-done-text-and-check-mark-xs.jpg"
  alt: "Done image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_8431094_done_text_and_check_mark_xs_jpg from "photodune-8431094-done-text-and-check-mark-xs.jpg";


<Image decoding="async" alt="Done image licensed from Photodune" width="516" height="387" sizes="(max-width: 516px) 100vw, 516px" src={colo_photodune_8431094_done_text_and_check_mark_xs_jpg} widths={[516, 300]} />  
In response to my recent [Story Splitting post](/blog/story-slicing-how-small-is-enough.html), I had a few questions and couple of confusions that need clearing up.
