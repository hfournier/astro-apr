...
description: 'Learn how to Estimate in Agile Scrum for Sprint Planning and Backlog Grooming/Refinement Sessions. The value of Planning Poker™ and blind estimates.'
type: post
createdAt: 2012-06-26T13:33:53
modifiedAt: 2022-03-25T20:26:56
author: mark-levison
categories:
  - estimations
  - scrum-by-example
...
featuredMedia:
  id: 10303
  src: "photodune-1602425-cards-hand-xs.jpg"
  alt: "Hand of cards - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_1602425_cards_hand_xs_jpg from "photodune-1602425-cards-hand-xs.jpg";
import colo_architects_xs_jpg from "architects-xs.jpg";


<Image decoding="async" alt="Hand of cards - - image licensed from Photodune" width="548" height="365" sizes="(max-width: 548px) 100vw, 548px" src={colo_photodune_1602425_cards_hand_xs_jpg} widths={[548, 300]} />
...
<Image decoding="async" alt="An image of two architects' hands doing work - image licensed from Photodune " width="450" height="300" sizes="(max-width: 450px) 100vw, 450px" src={colo_architects_xs_jpg} widths={[547, 300]} />What are the team’s options at this point?
