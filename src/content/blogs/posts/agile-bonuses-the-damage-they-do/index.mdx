...
type: post
createdAt: 2022-12-07T08:05:56
modifiedAt: 2023-04-13T13:45:25
author: mark-levison
categories:
  - anti-patterns
tags:
...
featuredMedia:
  id: 14577
  src: "Bonuses-anti-pattern-CLD.png"
  alt: "Bonuses anti pattern CLD"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Bonuses_anti_pattern_CLD_1_png from "Bonuses-anti-pattern-CLD-1.png";
import colo_Bonuses_anti_pattern_CLD_2_png from "Bonuses-anti-pattern-CLD-2.png";
import colo_Bonuses_anti_pattern_CLD_png from "Bonuses-anti-pattern-CLD.png";


_A design pattern is a description of a solution to a recurring problem. It outlines the elements that are necessary to solve the challenge without prompting the reader to address the issue in a specific way.  
__Unfortunately, we also regularly see recurring patterns of ineffective behaviour. These are called [Anti-Patterns](/glossary/scrummaster-anti-patterns).  
The following explores the common anti-pattern of a performance bonus. Micromanagement._
...
<Image decoding="async" alt="TODO: update alt text" width="1418" height="635" sizes="(max-width: 1418px) 100vw, 1418px" src={colo_Bonuses_anti_pattern_CLD_1_png} widths={[1418, 300, 1024, 768]} />
...
<Image decoding="async" alt="TODO: update alt text" width="1418" height="552" sizes="(max-width: 1418px) 100vw, 1418px" src={colo_Bonuses_anti_pattern_CLD_2_png} widths={[1418, 300, 1024, 768]} />
...
<Image decoding="async" alt="Bonuses anti pattern CLD" width="1425" height="887" sizes="(max-width: 1425px) 100vw, 1425px" src={colo_Bonuses_anti_pattern_CLD_png} widths={[1425, 300, 1024, 768]} />
...
**[_Why Motivating People Doesn’t Work and What Does_](https://www.amazon.ca/Motivating-People-Doesnt-Work-What/dp/1626569452/&tag=notesfromatoo-20)** – Susan Fowler  
Intrinsic motivation—motivation that comes from inside us— is more sustainable than extrinsic or external motivation. The famous carrot or stick.

[**Self-Determination Theory in Work Organizations: The State of a Science**](https://www.researchgate.net/publication/312960448_Self-Determination_Theory_in_Work_Organizations_The_State_of_a_Science) – Deci, Olafsen, Ryan  
When our work environment has bonuses, the bonuses reduce the effect of the intrinsic motivation.
