...
description: 'The story of an Agile/Scrum Team and the problems they run into once their sites go live. Analysis includes different approaches to solving lost productivity.'
type: post
createdAt: 2011-10-04T03:19:25
modifiedAt: 2021-02-12T20:33:32
author: mark-levison
categories:
  - scrum
  - scrum-by-example
...
featuredMedia:
  id: 10347
  src: "photodune-1105342-tripod-xs.jpg"
  alt: "Tripod - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_1105342_tripod_xs_jpg from "photodune-1105342-tripod-xs.jpg";


<Image decoding="async" alt="Tripod - image licensed from Photodune" width="364" height="548" sizes="(max-width: 364px) 100vw, 364px" src={colo_photodune_1105342_tripod_xs_jpg} widths={[364, 199]} />_This article has been updated. You can find the newest version of this content [here](/blog/scrum-production-support.html)._
