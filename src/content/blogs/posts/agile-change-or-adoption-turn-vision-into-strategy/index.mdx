...
type: post
createdAt: 2016-06-21T15:18:47
modifiedAt: 2020-04-21T18:20:51
author: mark-levison
categories:
  - agile
  - beyond-scrum
...
featuredMedia:
  id: 8979
  src: "Be-Always-Changing-vision-to-strategy.jpg"
  alt: "Be Always Changing - vision to strategy - image by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_Be_Always_Changing_vision_to_strategy_jpg from "Be-Always-Changing-vision-to-strategy.jpg";
import colo_X_Matrix_Karl_Scotland_jpeg from "X-Matrix-Karl-Scotland.jpeg";
import colo_WSOBS_Vision_for_Improvement_jpeg from "WSOBS-Vision-for-Improvement.jpeg";


<Image decoding="async" alt="Be Always Changing - vision to strategy - image by Agile Pain Relief Consulting" width="700" height="500" sizes="(max-width: 700px) 100vw, 700px" src={colo_Be_Always_Changing_vision_to_strategy_jpg} widths={[700, 300]} />
...
<Image decoding="async" alt="X Matrix cc license Karl Scotland" width="432" height="321" sizes="(max-width: 432px) 100vw, 432px" src={colo_X_Matrix_Karl_Scotland_jpeg} widths={[432, 300]} />
...
<Image decoding="async" alt="Worlds Smallest Online Bookstore Vision for Improvement - image by Agile Pain Relief Consulting with elements from Freepik" width="550" height="356" sizes="(max-width: 550px) 100vw, 550px" src={colo_WSOBS_Vision_for_Improvement_jpeg} widths={[550, 300]} />
