...
description: 'How long should a Scrum Sprint be? A Scrum Sprint is a short period of time when the Scrum Team works, but there is no hard rule as to how long that should be – in this post, we cover the pros and cons of shorter and longer Sprints and how you can discover what ...'
type: post
createdAt: 2019-11-05T07:37:56
modifiedAt: 2023-05-17T21:57:55
author: mark-levison
categories:
  - scrum
  - sprint
...
featuredMedia:
  id: 10083
  src: "APR-Blog-Illustrations_Oct2019_SprintLengths_B_v2.jpg"
  alt: "Choosing a Scrum Sprint Length – Shorter Beats Longer - image by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_APR_Blog_Illustrations_Oct2019_SprintLengths_A_v1_jpg from "APR-Blog-Illustrations_Oct2019_SprintLengths_A_v1.jpg";
import colo_APR_Blog_Illustrations_Oct2019_SprintLengths_B_v2_jpg from "APR-Blog-Illustrations_Oct2019_SprintLengths_B_v2.jpg";
...
<Image decoding="async" alt="How to choose a Scrum Sprint Length - image by Agile Pain Relief Consulting" width="1416" height="840" sizes="(max-width: 1416px) 100vw, 1416px" src={colo_APR_Blog_Illustrations_Oct2019_SprintLengths_A_v1_jpg} widths={[1416, 300, 1024, 768]} />
...
### <Image decoding="async" alt="How to choose a Scrum Sprint Length – Shorter Beats Longer - image by Agile Pain Relief Consulting" width="1416" height="840" sizes="(max-width: 1416px) 100vw, 1416px" src={colo_APR_Blog_Illustrations_Oct2019_SprintLengths_B_v2_jpg} widths={[1416, 300, 1024, 768]} />
...
*   To do well with shorter Sprints, Scrum Development Teams need to work on some skills:  
    – [Story Splitting](/blog/scrummaster-tales-story-splitting-fun.html) – so that they divide the work into small manageable chunks  
...
\[2\] [https://info.scrumalliance.org/State-of-Scrum-2017-18.html](https://www.scrumalliance.org/ScrumRedesignDEVSite/media/ScrumAllianceMedia/Files%20and%20PDFs/State%20of%20Scrum/2017-SoSR-Final-Version-\(Pages\).pdf)
