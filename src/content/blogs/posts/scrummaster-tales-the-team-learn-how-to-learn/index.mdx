...
description: 'A Standup report leads our case study ScrumMaster to arrange for his Scrum team to use Coding Dojos to build confidence and pay down Technical Debt.'
type: post
createdAt: 2012-03-28T02:47:27
modifiedAt: 2021-11-26T20:16:03
author: mark-levison
categories:
  - scrum-by-example
tags:
...
featuredMedia:
  id: 10313
  src: "photodune-1277447-dark-dojo-xs.jpg"
  alt: "dark dojo - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_1277447_dark_dojo_xs_jpg from "photodune-1277447-dark-dojo-xs.jpg";


<Image decoding="async" alt="dark dojo - image licensed from Photodune" width="548" height="365" sizes="(max-width: 548px) 100vw, 548px" src={colo_photodune_1277447_dark_dojo_xs_jpg} widths={[548, 300]} />  
