...
description: 'A response to objections about multiple return statements in my recent post on Minimal Coding Style, covering the history and my thoughts on methods.'
type: post
createdAt: 2008-08-03T10:57:57
modifiedAt: 2024-03-05T14:15:28
author: mark-levison
categories:
...
featuredMedia:
  id: 10453
  src: "doorway-xs.jpg"
  alt: "Doorway - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_doorway_xs_jpg from "doorway-xs.jpg";


<Image decoding="async" alt="Doorway - image licensed from Photodune" width="382" height="523" sizes="(max-width: 382px) 100vw, 382px" src={colo_doorway_xs_jpg} widths={[382, 219]} />  
It’s funny just about the only thing anyone really objected to from my recent post on [Minimal Coding Style](/blog/minimalist-coding-style.html) was multiple return statements.
