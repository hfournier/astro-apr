...
featuredMedia:
  id: 8882
  src: "AgilePainRelief_BlogIllustrations_Jan2019_Image1_v2.jpg"
  alt: "Scrum By Example – How to Deal with Bad User Stories as a ScrumMaster- image owned by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_AgilePainRelief_BlogIllustrations_Jan2019_Image1_v2_1024x607_jpg from "AgilePainRelief_BlogIllustrations_Jan2019_Image1_v2-1024x607.jpg";
...
<Image decoding="async" alt="Scrum By Example – How to Deal with Bad User Stories as a ScrumMaster" width="1024" height="607" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_AgilePainRelief_BlogIllustrations_Jan2019_Image1_v2_1024x607_jpg} widths={[1024, 300, 768, 1416]} />
