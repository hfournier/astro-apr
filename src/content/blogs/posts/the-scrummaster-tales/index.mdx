...
description: 'There are stacks of articles written about Scaling Agile and great technical books, but very little on playing roles well. This series explores Scrum Masters.'
type: post
createdAt: 2011-07-07T22:26:51
modifiedAt: 2020-01-31T01:26:35
author: mark-levison
categories:
...
featuredMedia:
  id: 10354
  src: "photodune-9297562-example-stamp-xs.jpg"
  alt: "Example stamp - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_9297562_example_stamp_xs_jpg from "photodune-9297562-example-stamp-xs.jpg";


<Image decoding="async" alt="Example stamp - image licensed from Photodune" width="553" height="362" sizes="(max-width: 553px) 100vw, 553px" src={colo_photodune_9297562_example_stamp_xs_jpg} widths={[553, 300]} />  
