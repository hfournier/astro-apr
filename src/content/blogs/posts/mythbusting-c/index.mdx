...
description: 'While researching "Are there weaknesses with Collective Code Ownership?" for InfoQ, I was struck by the number of myths around Collective Code Ownership.'
type: post
createdAt: 2008-05-07T03:22:55
modifiedAt: 2020-01-31T09:44:38
author: mark-levison
categories:
...
featuredMedia:
  id: 10461
  src: "working-together-xs.jpg"
  alt: "Working together - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_working_together_xs_jpg from "working-together-xs.jpg";


<Image decoding="async" alt="Working together - image licensed from Photodune" width="546" height="366" sizes="(max-width: 546px) 100vw, 546px" src={colo_working_together_xs_jpg} widths={[546, 300]} />  
In researching “[Are there weaknesses with Collective Code Ownership?](https://www.infoq.com/news/2008/05/weaknesses_collective_code)” for a news item on InfoQ I was struck by the number of myths that get repeated around Collective Code Ownership. I thought it time to burst a few balloons.
