...
featuredMedia:
  id: 16017
  src: "APR-Story-of-a-Sprint-board-07.png"
  alt: "Daily Scrum standup - Development team reviews Sprint Backlog, image by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_APR_Story_of_a_Sprint_board_07_1024x576_png from "APR-Story-of-a-Sprint-board-07-1024x576.png";
import colo_Daily_Scrum_comment_png from "Daily-Scrum-comment.png";
...
<Image decoding="async" alt="Daily Scrum standup - Development team reviews Sprint Backlog, image by Agile Pain Relief Consulting" width="1024" height="576" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_APR_Story_of_a_Sprint_board_07_1024x576_png} widths={[1024, 300, 768, 1536, 1920]} />
...
<Image decoding="async" alt="Daily-Scrum-comment" width="899" height="204" sizes="(max-width: 899px) 100vw, 899px" src={colo_Daily_Scrum_comment_png} widths={[899, 300, 768]} />
