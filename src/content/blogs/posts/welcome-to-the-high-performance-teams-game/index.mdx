...
featuredMedia:
  id: 10211
  src: "High-Performance-Teams-Game.jpg"
  alt: "High-Performance Teams Game - image and game by Agile Pain Relief Consulting. Elements of image by Juancho10 and Canva"
  caption: ""
---

import { Image } from "astro:assets"

import colo_High_Performance_Teams_Game_jpg from "High-Performance-Teams-Game.jpg";


<Image decoding="async" alt="High Performance Teams Game Banner" width="1024" height="768" sizes="(max-width: 1024px) 100vw, 1024px" src={colo_High_Performance_Teams_Game_jpg} widths={[1024, 300, 768]} />  
_Your team is working on the World’s Smallest Online Bookstore, a site that provides the best results (just a few) for every search, not every result on earth. We’re a vulture capital funded company, so if we don’t deliver, our funding will be cut._
...
[![Creative Commons License Icon](https://i.creativecommons.org/l/by-sa/4.0/88x31.png)](https://creativecommons.org/licenses/by-sa/4.0/)  
High-Performance Teams Game by [Mark Levison – Agile Pain Relief Consulting](https://agilepainrelief.com) is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-sa/4.0/).
...
\[1\] Sandy Pentland – [The New Science of Building Great Teams](https://hbr.org/2012/04/the-new-science-of-building-great-teams)  
\[2\] Ben Waber – [People Analytics](https://www.amazon.ca/People-Analytics-Technology-Transform-Business/dp/0133158314/&tag=notesfromatoo-20)
