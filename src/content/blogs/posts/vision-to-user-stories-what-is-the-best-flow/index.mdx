...
featuredMedia:
  id: 10170
  src: "User-Stories-Flow.jpg"
  alt: "Vision to User Stories - What is the Best Flow - image by Agile Pain Relief Consulting"
  caption: ""
---

import { Image } from "astro:assets"

import colo_User_Stories_Flow_jpg from "User-Stories-Flow.jpg";
...
<Image decoding="async" alt="Vision to User Stories - What is the Best Flow - image by Agile Pain Relief Consulting" width="1174" height="277" sizes="(max-width: 1174px) 100vw, 1174px" src={colo_User_Stories_Flow_jpg} widths={[1174, 300, 1024, 768]} />
