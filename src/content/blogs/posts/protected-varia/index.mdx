...
description: 'This has been said before: Protected variables are evil (blog post gone). But apparently as I''ve been doing some debugging into the Eclipse code I''m reminded it needs saying again. Let''s suppose we write a base class public class SimpleBase'
type: post
createdAt: 2007-10-10T02:01:58
modifiedAt: 2020-01-31T10:35:58
author: mark-levison
categories:
