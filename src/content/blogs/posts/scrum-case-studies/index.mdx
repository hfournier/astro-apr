...
description: 'Development teams ask for case studies about agile, but didn''t before adopting their existing process. This blog post collects 14 Scrum case studies.'
type: post
createdAt: 2008-11-04T04:15:13
modifiedAt: 2024-03-26T15:25:38
author: mark-levison
categories:
...
featuredMedia:
  id: 10444
  src: "photodune-744861-folders-xs.jpg"
  alt: "stack of folders - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_744861_folders_xs_jpg from "photodune-744861-folders-xs.jpg";


<Image decoding="async" alt="stack of folders - image licensed from Photodune" width="516" height="387" sizes="(max-width: 516px) 100vw, 516px" src={colo_photodune_744861_folders_xs_jpg} widths={[516, 300]} />I’ve recently been asked by one team to provide them with case studies/success stories about Scrum to prove scrum works. It is striking that the people ask for case studies about agile – but didn’t before adopting their existing process.
...
DDJ has [Embedded Agile: A Case Study In Numbers](https://www.drdobbs.com/architecture-and-design/embedded-agile-a-case-study-in-numbers/193501924) an article that demonstrates Agile working in the embedded environment. Timo Punkka documents Schneider-Electric’s  
...
_Update: Added Case Studies from Mishkin and Rally. Latest additions Keith’s efforts and Timo’s embedded paper. Added samples from Danube.  
_
