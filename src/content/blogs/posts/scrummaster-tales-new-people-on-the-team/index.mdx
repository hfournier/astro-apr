...
description: 'Hiring, adding, or changing a Team member in Scrum means the whole Scrum team has to adjust. How a ScrumMaster can help during transition, and problems to avoid.'
type: post
createdAt: 2012-04-10T14:03:40
modifiedAt: 2024-03-07T18:55:04
author: mark-levison
categories:
  - scrum-by-example
  - teams
...
featuredMedia:
  id: 10311
  src: "photodune-11869872-playing-in-the-sandbox-xs.jpg"
  alt: "playing in the sandbox - image licensed from Photodune"
  caption: ""
---

import { Image } from "astro:assets"

import colo_photodune_11869872_playing_in_the_sandbox_xs_jpg from "photodune-11869872-playing-in-the-sandbox-xs.jpg";


<Image decoding="async" alt="playing in the sandbox - image licensed from Photodune" width="579" height="346" sizes="(max-width: 579px) 100vw, 579px" src={colo_photodune_11869872_playing_in_the_sandbox_xs_jpg} widths={[579, 300]} />  
...
\[1\] Any resemblance to the author of this blog is purely accidental as Kirkby is a fiction of my imagination.  
\[2\] To make this work, the team need some basic interview training so they avoid the various legal pitfalls. Ragnwald had some great examples recently in: “[I hereby (fictionally) resign](https://raganwald.posterous.com/i-hereby-resign)”
