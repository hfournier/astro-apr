...
type: post
createdAt: 2016-09-06T06:23:07
modifiedAt: 2022-05-31T23:53:56
author: mark-levison
categories:
  - beyond-scrum
  - scrum-tools
...
People might argue about whether an item is a defect or just a new User Story.

Static Code Analysis (e.g. tools like [Sonar](https://www.sonarsource.com) and [FindBugs](https://findbugs.sourceforge.net/), [PMD](https://pmd.github.io/))
...
Highlights [Dark Work](/blog/kanban-portfolio-view-continued.html) and other things that are distracting the team
...
Can be [used to forecast](/blog/red-yellow-green-or-rygrag-reports-how-they-hide-the-truth.html) when a feature will be released. It can also help a team spot long-term trends in their own work.
...
[Skills Matrix](/blog/scrummaster-tales-the-team-gets-bottlenecked.html)/Team Learning
...
measure should force us to discover [Feature Teams](https://www.infoq.com/articles/scaling-lean-agile-feature-teams/). And if we have, it should force us to invest in skills where we still depend on other teams.
...
[https://www.innolution.com/blog/team-performance-measures](https://innolution.com/blog/team-performance-measures)  
[https://leankit.com/blog/2016/03/why-vanity-metrics-are-dangerous-holding-a-mirror-up-to-your-measures-of-success/](https://blog.planview.com/why-vanity-metrics-are-dangerous-holding-a-mirror-up-to-your-measures-of-success/)  
[https://martinfowler.com/articles/useOfMetrics.html](https://martinfowler.com/articles/useOfMetrics.html)  
[https://fourhourworkweek.com/2009/05/19/vanity-metrics-vs-actionable-metrics/](https://tim.blog/2009/05/19/vanity-metrics-vs-actionable-metrics/)  
[https://blog.crisp.se/2011/10/19/anderslaestadius/the-happiness-metric-and-a-few-others](https://blog.crisp.se/2011/10/19/anderslaestadius/the-happiness-metric-and-a-few-others)  
Formally documents the use of happiness as a Metric in Retrospectives  
[https://sites.google.com/a/scrumplop.org/published-patterns/retrospective-pattern-language/scrumming-the-scrum](https://sites.google.com/a/scrumplop.org/published-patterns/retrospective-pattern-language/scrumming-the-scrum)  
Happiness Bubble [https://sites.google.com/a/scrumplop.org/published-patterns/product-organization-pattern-language/beyond-the-happy-bubble](https://sites.google.com/a/scrumplop.org/published-patterns/product-organization-pattern-language/beyond-the-happy-bubble)

\[1\] [https://en.wikiquote.org/wiki/Eliyahu\_M.\_Goldratt](https://en.wikiquote.org/wiki/Eliyahu_M._Goldratt)  
\[2\] [https://en.wikipedia.org/wiki/Six\_Sigma](https://en.wikipedia.org/wiki/Six_Sigma)  
\[3\] [The Impact of Cognitive Biases on Delays in Product Development Teams](https://www.academia.edu/6447648/THE_IMPACT_OF_COGNITIVE_BIASES_ON_DELAYS_IN_PRODUCT_DEVELOPMENT_TEAMS)  
